...
class MailService
{
    ...
    public function __construct()
    {
        ...
        // Default sender
        $this->mailer->setFrom(self::env('MAIL_FROM', 'noreply@sensea.cc'), self::env('MAIL_FROM_NAME', 'Sensea Snoezelen'));
    }
    ...
    public function sendMagicLink(string $email, string $firstName, string $token): bool
    {
        try {
            ...
            $this->mailer->Subject = 'Votre lien de connexion - Sensea Snoezelen';
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 30px; font-size: 16px; color: #555; line-height: 1.6;">
                                Vous avez demandé à vous connecter à votre espace Sensea Snoezelen.
                    ...
                    <tr>
                        <td style="padding: 20px 40px; background-color: #f8f9fa; border-radius: 0 0 12px 12px; text-align: center;">
                            <p style="margin: 0; font-size: 12px; color: #999;">
                                Cet email a été envoyé par Sensea Snoezelen.<br>
...
---
Cet email a été envoyé par Sensea Snoezelen.
Pour des raisons de sécurité, ne partagez jamais ce lien.
TEXT;
    }
}
