    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div data-animate="fade-up"
            ...
            <div class="space-y-3">
                ...
                <a href="/premiere-seance" class="inline-flex items-center gap-1 text-xs text-primary hover:text-primary/80 transition">
                    Pourquoi la 1ère séance est-elle plus longue ?
