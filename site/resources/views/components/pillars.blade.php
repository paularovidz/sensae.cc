    ...
    <div class="container space-y-16 md:space-y-28">
        ...
        <div class="grid gap-x-12 gap-y-10 md:grid-cols-2 lg:grid-cols-3 aos-init aos-animate" data-aos="fade-up-sm" data-aos-delay="200">
            ...
            <div class="border-primary/40 before:bg-primary relative space-y-5 before:absolute before:-left-px before:content-[''] last:border-b-0 last:pb-0 max-sm:border-b max-sm:pb-10 before:max-sm:bottom-0 before:max-sm:h-px before:max-sm:w-1/4 last:before:max-sm:hidden sm:border-l sm:pl-10 before:sm:top-1/2 before:sm:h-1/4 before:sm:w-px before:sm:-translate-y-1/2">
                ...
                <h3 class="h4">✨ Détente</h3>
                <p>Dans la salle Snoezelen, le temps s’arrête. L’ambiance douce et sécurisante invite à relâcher les tensions physiques et émotionnelles. Cet espace de calme favorise un mieux-être global, où la personne peut se recentrer, souffler et retrouver un équilibre intérieur.</p>
            </div>
            <div class="border-primary/40 before:bg-primary relative space-y-5 before:absolute before:-left-px before:content-[''] last:border-b-0 last:pb-0 max-sm:border-b max-sm:pb-10 before:max-sm:bottom-0 before:max-sm:h-px before:max-sm:w-1/4 last:before:max-sm:hidden sm:border-l sm:pl-10 before:sm:top-1/2 before:sm:h-1/4 before:sm:w-px before:sm:-translate-y-1/2">
                <h3 class="h4">💜 Relationnel</h3>
                <p>Le cadre Snoezelen offre un terrain privilégié pour la rencontre. Accompagnant et accompagné partagent un moment de complicité, dans le respect du rythme de chacun. Cette relation authentique, nourrie par l’expérience sensorielle et la détente, renforce la confiance et le sentiment de sécurité.</p>
            </div>
        </div>
    </div>
</section>