    ...
    list:
      - active: true
        ...
        content: |
          ...
          - Des textures agréables à toucher
      - active: false
        ...
        content: |
          ...
          - Personnes en situation de handicap (la salle est équipée d'un lève personne)
          - Jeunes mamans
          - Toute personne cherchant à se détendre et se recentrer
      - active: false
        title: "Faut-il prendre rendez-vous pour une séances multi-sensorielle ?"
        content: |
          Oui, la réservation est nécessaire pour garantir :
          - Un espace privatisé
          - Un accompagnement personnalisé
          - Une ambiance calme sans interruption
          - Vous pouvez réserver en ligne ou par téléphone.
      - active: false
        title: "Comment se déroule une séance ?"
        content: |
          - Accueil chaleureux et bilan sensoriel
          - Installation dans la salle Snoezelen
          - Séance guidée avec une éducatrice spécialisée formée au Snoezelen
